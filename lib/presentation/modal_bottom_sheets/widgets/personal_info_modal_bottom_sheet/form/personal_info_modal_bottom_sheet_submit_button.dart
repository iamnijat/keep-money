...
class PersonalInfoModalBottomSheetSubmitButton extends StatefulWidget {
  final PersonalInfoModalBottomSheetCubit _cubit;
  final PersonalInfoModalBottomSheetState _state;

  const PersonalInfoModalBottomSheetSubmitButton(this._cubit, this._state,
      {Key? key})
      : super(key: key);

  @override
  State<PersonalInfoModalBottomSheetSubmitButton> createState() =>
      _PersonalInfoModalBottomSheetSubmitButtonState();
}

class _PersonalInfoModalBottomSheetSubmitButtonState
    extends State<PersonalInfoModalBottomSheetSubmitButton> {
  bool get _isLoading =>
